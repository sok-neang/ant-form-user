export const questions = [
  ...
  { text: '8. តើអ្នកកំពុងសិក្សានៅកម្រិតសញ្ញាបត្រណាដែរ?', 
    type: 'select', 
    options: [
      { label: 'បរិញ្ញាបត្រ', value: 'bachelor' }, 
      { label: 'បរិញ្ញាបត្រជាន់ខ្ពស់', value: 'master' }
    ] 
  },
  ...
  { text: '11. តើអ្នកកំពុងសិក្សាឆមាសទីប៉ុន្មាន?', 
    type: 'select', 
    options: [
      { label: 'ឆមាសទី១', value: '1' }, 
      { label: 'ឆមាសទី២', value: '2' }
    ] 
  },
  ...
  { text: '14. តើអ្នកទទួលបានព័ត៌មានអាហារូបករណ៍របស់យើងតាមរយៈអ្វីដែរ?', 
    type: 'select', 
    options: [
      { label: 'មិត្តភក្ក', value: 'friend' }, 
      { label: ' បណ្តាញសង្គម', value: 'social' }, 
      { label: ' សិស្សច្បង', value: 'senior' }, 
  ...
  { text: '21. សូមជ្រើសរើសម៉ោងសិក្សាដែលអ្នកចង់រៀន', 
    type: 'radio', 
    options: [
      { label: 'វេនព្រឹក ចន្ទ ដល់ សៅរ៍ ម៉ោង ០៧:៥០ ដល់ ១០:៥០', value: 'MORNING' }, 
      { label: 'វេនរសៀល ចន្ទ ដល់ សៅរ៍ ម៉ោង ០២:០០ ដល់ ០៥:០០', value: 'AFTERNOON' }
    ] 
  },
